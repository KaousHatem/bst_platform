...
export const StockInDocumentAddToolbar = ({ isAdd = false, id, selectedFile, status, props }) => {
    ...
    const handlePrint = () => {
        if (id) {
            console.log(id)
            const url = '/stock-in/print?id=' + id
        ...
        >
            ...
            <Box sx={{ m: 1 }}>
                ...
                {isAdd && <Button
                    color="info"
                    variant="contained"
                    form="add-stock-in-document-form"
                    type="submit"
                ...
                {!isAdd && status === "1" && <Button
                    color="info"
                    variant="contained"
                    form="edit-stock-in-document-form"
                    type="submit"
