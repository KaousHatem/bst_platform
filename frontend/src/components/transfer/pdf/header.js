...
const Header = ({ transfer, page, pages }) => {
        ...
        <View style={styles.headerContainer}>
            ...
            <View style={styles.headerHorizontal}>
                <View>
                    ...
                    <Text style={styles.refrence}>Ref: BST/LOG/n° {transfer.ref}</Text>
                </View>
            ...
            <View style={styles.subHeader}>
                <View style={styles.subHeaderItem} >
                    ...
                    <View style={styles.subHeaderContent}>
                        <Text>{transfer.source.name}</Text>
                ...
                <View style={[styles.subHeaderItem, styles.subHeaderDestination]}>
                    ...
                    <View style={styles.subHeaderContent} >
                        <Text>{transfer.target.name}</Text>
