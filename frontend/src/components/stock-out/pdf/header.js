...
const Header = ({ stockOutDocument, page, pages }) => {
    ...
    return (
        <View style={styles.headerContainer}>
            <Image width={window && window.innerWidth}
                style={styles.logo}
                src={header.src} />
            <Text style={styles.documentTitle}>BON DE SORTIE</Text>
            <View style={styles.headerHorizontal}>
                <View>
                    <Text style={styles.directionTitle}>direction logistique</Text>
                    <Text style={styles.refrence}>Ref: BST/LOG/n° {stockOutDocument.ref}</Text>
                </View>
            ...
            <View style={styles.subHeader}>
                <View style={styles.subHeaderItem} >
                    ...
                    <View style={styles.subHeaderContent}>
                        <Text>{stockOutDocument.store.name}</Text>
                ...
                <View style={[styles.subHeaderItem, styles.subHeaderDestination]}>
                    ...
                    <View style={styles.subHeaderContent} >
                        <Text>{target_text[stockOutDocument.target]}</Text>
                        <Text>{stockOutDocument.target_detail}</Text>
                        <Text>{stockOutDocument.note}</Text>
