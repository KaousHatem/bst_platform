...
export const StockOutDocumentAddToolbar = ({ isAdd = false, id, selectedFile, status, props }) => {
    ...
    const handlePrint = () => {
        if (id) {
            console.log(id)
            const url = '/stock-out/print?id=' + id
        ...
        >
            ...
            <Box sx={{ m: 1 }}>
                ...
                {isAdd && <Button
                    color="info"
                    variant="contained"
                    form="add-stock-out-document-form"
                    type="submit"
                ...
                {!isAdd && status === "1" && <Button
                    color="info"
                    variant="contained"
                    form="edit-stock-out-document-form"
                    type="submit"
