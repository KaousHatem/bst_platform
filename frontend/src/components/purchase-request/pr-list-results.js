  ...
  const handleDeletePurchaseRequest = () => {
    ...
    PurchaseRequestProvider.deletePurchaseRequest(purchaseRequestIdDelete).then(
      (response) => {
        ...
        setPurchaseRequests(
          purchaseRequests.filter(function (purchaseRequest) {
              ...
              <TableRow>
                <TableCell padding="checkbox">
                  <Checkbox
                    ...
                    color="primary"
                    indeterminate={
                      selectedPRIds.length > 0 && selectedPRIds.length < purchaseRequests.length
                    }
                    onChange={handleSelectAll}
                  />
                </TableCell>
                <TableCell>Reference</TableCell>
                <TableCell>demande d&apos;appro</TableCell>
              ...
              {filteredPurchaseRequest
                ...
                .map((purchaseRequest) => (
                  ...
                  >
                    ...
                    <TableCell>{purchaseRequest.ref}</TableCell>
                    <TableCell>{purchaseRequest.provision.ref}</TableCell>
                    <TableCell
                      sx={{
                        width: "40%",
                      }}
                    ...
                    <TableCell>{purchaseRequest.created_by.fullname}</TableCell>
                    <TableCell align="center">
                      <Label
                      ...
                      >
                        {(purchaseRequest.status !== "0" && (
                          <ViewIcon
                            ...
                            onClick={(event) => {
                              handleClickEdit(event, purchaseRequest);
                            }}
                          />
                        )) || (
                          <>
                            ...
                            <DeleteIcon
                              ...
                              onClick={(event) => {
                                handleDeleteOpen(event, purchaseRequest.id);
                              }}
                            />
                          </>
                        )}
